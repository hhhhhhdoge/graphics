    ...
    switch(key){
        ...
        case 'c':
            ...
            for (it = v_point.begin(); it != v_point.end(); it++){
                line.clear();
                GLint x11 = (*it).x, y11 = (*it).y; it--;
                GLint x22 = (*it).x, y22 = (*it).y; it++;
                tmp.x = x11; tmp.y = y11; line.push_back(tmp);
                tmp.x = x22; tmp.y = y22; line.push_back(tmp);
